...
* Birthday Cake Candles: [Problem](https://www.hackerrank.com/challenges/birthday-cake-candles);   [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/birthday-cake-candles.cpp).
...
* Counting Valleys: [Problem](https://www.hackerrank.com/challenges/counting-valleys);   [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/counting-valleys.cpp).
* Electronic Shop: [Problem](https://www.hackerrank.com/challenges/electronics-shop);   [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/electronics-shop.cpp).
* Magic Square Forming: [Problem](https://www.hackerrank.com/challenges/magic-square-forming);   [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/magic-square-forming.cpp).
...
* Permutation Equation: [Problem](https://www.hackerrank.com/challenges/permutation-equation);   [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/permutation-equation.cpp).
...
* DFS: Connected Cells in a Grid: [Problem](https://www.hackerrank.com/challenges/ctci-connected-cell-in-a-grid);   [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/ctci-connected-cell-in-a-grid.cpp).
* Binary Search: Ice Cream Parlor: [Problem](https://www.hackerrank.com/challenges/ctci-ice-cream-parlor);   [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/ctci-ice-cream-parlor.cpp).
...
* K Factorization: [Problem](https://www.hackerrank.com/challenges/k-factorization);   [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/k-factorization.cpp).
...
* Bob and Ben: [Problem](https://www.hackerrank.com/challenges/bob-and-ben);      [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/bob-and-ben.cpp).
...
* Minimum Height Triangle: [Problem](https://www.hackerrank.com/challenges/lowest-triangle);   [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/lowest-triangle.cpp).
...
* Game of Two Stacks: [Problem](https://www.hackerrank.com/challenges/game-of-two-stacks);   [Code](https://github.com/yular/CC--InterviewProblem/blob/master/Hackerrank_InterviewStreet/game-of-two-stacks.cpp).
